...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/JackeeTEAM/Files_Jacke/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,729944438,539371484}
...
if tonumber(user_id) == tonumber(729944438) then  
var = true  
...
local Jacke_Msg = ''  
if msgs < 100 then 
Jacke_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
Jacke_Msg = 'بده يتحسن😕💔' 
elseif msgs < 400 then 
Jacke_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
Jacke_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
Jacke_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
Jacke_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
Jacke_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
Jacke_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
Jacke_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
Jacke_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
Jacke_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
Jacke_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
Jacke_Msg = 'رب التفاعل✔️😍'  
end 
return Jacke_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceJacke(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Jacke_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..Jackek..''..Jacke..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'CV2VC')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CV2VC')..')'
status  = '\n🔘| تم ترقيته مطور في البوت'
...
--------------------------------------------------------------------------------------------------------------
if Jacke_Msg and not Special(msg) then  
local Jacke_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Jacke_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Jacke_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/CV2VC)}\n📛¦["..Jacke_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/CV2VC)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CV2VC')..') \n🔘| تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CV2VC')..') \n🔘| تـم قفـل التاك بالكتم\n⛔| الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/JackeeTEAM/Files_Jacke/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات بويكا\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| قناة سورس بويكا ↓\n".."📮| [اضغط هنا لدخول](t.me/CV2VC) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/JackeeTEAM/Files_Jacke/master/File_Bot/"..file)
if res == 200 then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'CV2VC')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..Jacke_Msg[math.random(#Jacke_Msg)]..']') 
return false
end
...
Jacke = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Jacke)
...
--------------------------------------------------------------------------------------------------------------
SourceJacke(data.message_,data)
...
------------------------------------------------------------------------
local Jackebot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if Jackebot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Jackebot.."] \n") 

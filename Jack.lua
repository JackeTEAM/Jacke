...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/JackeTEAM/Files_Jack/master/File_Bot/commands.lua") 
...
Jack_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
Jack_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
Jack_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
Jack_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
Jack_Msg = 'رب التفاعل✔️😍'  
end 
return Jack_Msg 
end
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local Jack1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..Jack1.server.uptime_in_days..'('..Jack1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..Jack1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..Jack1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..Jack1.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('wget https://raw.githubusercontent.com/JackeTEAM/Jacke/master/Jack.lua')
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..Jackk..''..Jack..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/JackeTEAM/Files_Jack/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/JackeTEAM/Files_Jack/master/File_Bot/"..file)
if res == 200 then
...
------------------------------------------------------------------------
local Jackbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if Jackbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Jackbot.."] \n") 
